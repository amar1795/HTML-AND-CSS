...
window.gameStart=null;
    ...
    function gameover() {
        ...
        document.getElementById("info").innerHTML=`Your Score: ${getWpm()} Words Per Minute`
        }
    ...
    document.getElementById("game").addEventListener("keyup",(e)=>{
        ...
        // the below considtion should not be put above this as in that case it would avoid the program to run for the first time 
